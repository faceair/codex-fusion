...
- Distinguish facts from assumptions: cite or name direct evidence when available; when a claim is inferred or hypothetical, state the reasoning path or the next verification step.
